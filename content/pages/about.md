...
About the Journal
-----------------
Meet our [Editorial Board](editorial-board.html).
...
The model is coded in one of the [COMBINE standards](http://co.mbine.org/) such as [CellML](https://www.cellml.org/), [SBML](http://sbml.org/) or [NeuroML](https://www.neuroml.org/). For models encoded in CellML this allows the model to checked automatically for consistency of units and allows for the automatic generation of the mathematical equations behind the model and their coding in multiple languages (Python, Matlab, C, C++, Fortran, etc). 
